                    ...
                    <form action="<?php echo base_url('Dashboards/search');?>" method="post"
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
                                aria-label="Search" aria-describedby="basic-addon2" name="searchinput">
                            ...
                            <li> 
                                <div class="cart float-right">
                                    <label data-toggle="collapse" data-target="#ViewCart">
                                        <i class="fas fa-cart-plus" style="color: rgb(0, 0, 0);"></i>
                                        <span class="items-count" id="items_count" data-totalcart="<?php echo $this->cart->total_items()?>"><?php echo $this->cart->total_items(); ?></span>
                                    </label> 
